...
create table  mireia_hernandez.revision(
	km integer  NOT NULL,
	id_coche integer NOT NULL, -- PK, FK --> coches
	id_divisa integer  NOT NULL, -- FK --> divisas
	fecha_de_inspeccion date NOT NULL, -- PK
	precio integer NOT NULL
);

alter table mireia_hernandez.revision
add constraint pk_revision primary key (fecha_de_inspeccion, id_coche);
...
alter table  mireia_hernandez.marcas
add constraint marcas foreign key (id_grupoempresarial)
...
alter table  mireia_hernandez.polizas
add constraint which_aseguradora foreign key (id_aseguradora)
...
alter table  mireia_hernandez.coches
add constraint type_modelo foreign key (id_modelo)
...
alter table  mireia_hernandez.revision
add constraint type_divisa foreign key (id_divisa)
...
insert into mireia_hernandez.coches
	(id_coche, id_modelo, id_color, fecha_de_compra, matricula, km_total)
...
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('001',35.000,'001','2023-02-14 12:00:00',60);

insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('002',35.000,'003','2023-02-14 11:00:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('003',35.000,'002','2023-02-14 10:00:00',60);

insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('004',35.000,'004','2023-02-16 13:00:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('005',75.000,'004','2023-02-16 16:00:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('006',35.000,'002','2023-03-14 15:00:00',60);

insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('007',80.000,'005','2023-01-01 10:00:00',60);

	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('007',35.000,'001','2024-06-04 18:00:00',65);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('008',70.000,'004','2023-01-01 12:30:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('009',35.000,'005','2023-08-05 11:00:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('010',90.000,'004','2024-08-10 17:45:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('011',35.000,'001','2023-01-10 09:00:00',65);

insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('012',65.000,'001','2023-12-14 08:30:00',60);

insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('013',35.000,'003','2023-04-25 17:10:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('014',120.000,'001','2023-05-17 07:30:00',60);
	
insert into mireia_hernandez.revision
	(id_coche, km, id_divisa, fecha_de_inspeccion, precio)
	values ('015',95.000,'001','2023-08-10 10:00:00',70);