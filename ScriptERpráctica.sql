...
insert into mireia_hernandez.coches
	(id_coche, id_modelo, id_color, fecha_compra, matricula, km_total)
	values ('002','002','004','2022-05-12','5254LKM',57000);

insert into mireia_hernandez.coches
	(id_coche, id_modelo, id_color, fecha_compra, matricula, km_total)
	values ('003','003','002','2017-11-02','7456FGG',34000);
...
insert into mireia_hernandez.revisiones
	...
	values ('001',35000,'001','2023-02-14 12:00',60);

insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('002',35000,'003','2023-02-14 11:00',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('003',35000,'002','2023-02-14 10:00',60);

insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('004',35000,'004','2023-02-16 13:00',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('005',75000,'004','2023-02-16 16:00',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('006',35000,'002','2023-03-14 15:00',60);

insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('007',80000,'005','2023-01-01 10:00',60);

	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('007',35000,'001','2024-06-04 18:00',65);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('008',70000,'004','2023-01-01 12:30',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('009',35000,'005','2023-08-05 11:00',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('010',90000,'004','2024-08-10 17:45',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('011',35000,'001','2023-01-10 09:00',65);

insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('012',65000,'001','2023-12-14 08:30',60);

insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('013',35000,'003','2023-04-25 17:10',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('014',120000,'001','2023-05-17 07:30',60);
	
insert into mireia_hernandez.revisiones
	(id_coche, km, id_divisa, fecha_revision, precio)
	values ('015',95000,'001','2023-08-10 10:00',70);